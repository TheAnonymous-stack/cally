...
def add_event(day, time, startTime, endTime, eventName):
    with open('/Users/hypebeast/Documents/Cally/cally.json') as schedule_file:
        schedule = json.load(schedule_file)
    #Check if schedule is empty
    if len(schedule[day]) == 0:
        schedule[day].append({"time": time, "startTime": startTime, "endTime": endTime, "eventName": eventName})
        with open('/Users/hypebeast/Documents/Cally/cally.json', 'w') as schedule_file:
            schedule_file.write("")
        with open('/Users/hypebeast/Documents/Cally/cally.json', "a") as schedule_file:
